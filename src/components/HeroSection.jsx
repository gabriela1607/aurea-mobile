...
const HeroSection = () => {
  ...
  const sendToWhatsApp = (data) => {
    ...
    // SUBSTITUA PELO SEU NÚMERO DE WHATSAPP (com DDD e código do país - 55 para Brasil)
    // Exemplo: 5511999999999 (11 é o DDD, 999999999 é o número)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Rolando suavemente para o formulário
        setTimeout(() => {
  ...
  return (
    <div className="bg-[#FAE6DD] dark:bg-[#8A6157] min-h-screen transition-colors duration-300 pt-16">
      ...
      <div className="lg:hidden flex flex-col items-center pt-24 px-4 pb-12">
        ...
        <img src={isDarkMode ? espelhoDark : espelho} alt="Espelho Áurea" className="w-64 h-64 object-contain mb-8"/>
        ...
        {isSubmitted ? (
          <div className="bg-green-100 border border-green-400 text-green-700 px-3 py-2 rounded relative mb-8 w-[241px] text-center">
            ...
            <button 
              onClick={() => setIsSubmitted(false)}
              className="mt-2 bg-[#61372F] text-[#FAE6DD] dark:text-[#F9E5DE] py-1 px-4 rounded text-xs"
            >
              Nova mensagem
            </button>
          </div>
          ...
          >
            ...
            <div className="flex justify-center mb-12">
              <button 
                type="submit"
                className="bg-[#61372F] text-[#FAE6DD] dark:text-[#F9E5DE] py-2 px-8 rounded transition-colors duration-300"
              >
